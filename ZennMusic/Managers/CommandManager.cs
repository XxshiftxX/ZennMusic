...
namespace ZennMusic.Managers
{
    public static class CommandManager
    {
        ...
        private static void RollDiceCommand(OnMessageReceivedArgs msgArgs, string[] cmdArgs)
        {
            ...
            ChatManager.SendMessage($"결과는 [ {new Random().Next(start, end + 1)} ] 입니다!");
        }
        ...
        private static string GetNameOfRequestType(RequestType type) => type switch
        {
            RequestType.Piece => "조각",
            RequestType.Ticket => "티켓",
